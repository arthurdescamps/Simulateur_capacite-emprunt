...
taux_credit = st.number_input("Entrez le taux du crédit", step = 0.0001, value = 0.02)
taux_assurance = st.number_input("Entrez le taux d'assurance", step = 0.0001, value = 0.008)
